...
const App = () => {
    ...
    const menu = [
        ...
        },
        {
            label: 'Tickets',
            items: [
                { label: 'Tickets List', icon: 'pi pi-fw pi-ticket', to: '/ticketsList' },
                { label: 'Create New Ticket', icon: 'pi pi-fw pi-plus', to: '/createNewTicket' },
            ]
        },
        {
            label: 'Problems',
            items: [
                { label: 'Problems List', icon: 'pi pi-fw pi-exclamation-triangle', to: '/problemsList' },
                { label: 'Create New Problem', icon: 'pi pi-fw pi-plus', to: '/createNewProblem' },
            ]
        },
        {
            label: 'Changes',
        ...
        },
        {
            label: 'Solutions',
            items: [
                { label: 'Articles', icon: 'pi pi-fw pi-list', to: '/articlesList' },
            ]
        },
        {
            label: 'Support',
