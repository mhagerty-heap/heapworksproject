...
const CreateNewChange = () => {
    ...
    const onSubmit = (data) => {
        ...
        const changesLocalCopy = sessionStorage.setItem('changesLocalCopy', ticketsString); // store updated changesLocalCopy sessionStorage
        setFormData(data);
        setShowMessage(true);
        reset();
    };
        ...
        <div className="form-demo">
            <Dialog visible={showMessage} onHide={() => setShowMessage(false)} position="top" footer={dialogFooter} showHeader={false} breakpoints={{ '960px': '80vw' }} style={{ width: '30vw' }}>
                <div className="flex justify-content-center flex-column pt-6 px-3">
                    ...
                    <h5>Change { newTicketNumber } Has Been Created!</h5>
                </div>
            </Dialog>

            <div className="grid p-fluid">
                <div className="card">
                    <h5>Create A Change</h5>
...
export default React.memo(CreateNewChange, comparisonFn);
