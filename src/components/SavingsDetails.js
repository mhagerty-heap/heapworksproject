...
const SavingsDetails = (props) => {
    ...
    const statuses = [
        'paid', 'received', 'processing', 'inquiry'
    ];
    ...
    useEffect(() => {
        ...
        customerService.getCustomersChecking().then(data => { setCustomers1(getCustomers(data)); setLoading1(false) });
        ...
        <div className="grid p-fluid">
          <div className="col-12 card">
              ...
              <DataTable value={customers1} paginator className="p-datatable-gridlines" showGridlines rows={10}
                  ...
                  <Column header="Transaction Amount" filterField="balance" dataType="numeric" style={{ minWidth: '10rem' }} body={balanceBodyTemplate} filter filterElement={balanceFilterTemplate} />
...
export default React.memo(SavingsDetails, comparisonFn);
